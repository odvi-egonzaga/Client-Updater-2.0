...
describe('Status Summary Routes', () => {
  ...
  describe('GET /api/status/summary', () => {
    ...
    it('should validate periodMonth range', async () => {
      ...
      const response1 = await app.request('/summary?companyId=FCASH&periodYear=2024&periodMonth=0')
      const json1 = await response1.json()
      ...
      const response2 = await app.request('/summary?companyId=FCASH&periodYear=2024&periodMonth=13')
      const json2 = await response2.json()
    ...
    it('should validate periodQuarter range', async () => {
      ...
      const response1 = await app.request('/summary?companyId=FCASH&periodYear=2024&periodQuarter=0')
      const json1 = await response1.json()
      ...
      const response2 = await app.request('/summary?companyId=FCASH&periodYear=2024&periodQuarter=5')
      const json2 = await response2.json()
