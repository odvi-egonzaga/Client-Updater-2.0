      ...
      return c.json(
        {
          success: false,
          error: {
            message: error instanceof Error ? error.message : 'Failed to retrieve client details',
          },
        },
        500
      )
          ...
          return c.json(
            {
              ...
              error: {
                code: 'FORBIDDEN',
                message: 'You do not have permission to view this client sync history',
              },
            },
            403
          )
      ...
      return c.json(
        {
          success: false,
          error: {
            message: error instanceof Error ? error.message : 'Failed to retrieve client sync history',
          },
        },
        500
      )
