...
export const clients = pgTable("clients", {
  ...
  pensionerTypeId: uuid("pensioner_type_id").references(
    () => pensionerTypes.id,
  ),
...
export const clientPeriodStatus = pgTable(
  ...
  (table) => ({
    uniquePeriod: unique("client_period_status_period_unique").on(
      table.clientId,
      table.periodType,
      table.periodMonth,
      table.periodQuarter,
...
export const statusEvents = pgTable("status_events", {
  ...
  clientPeriodStatusId: uuid("client_period_status_id")
    .notNull()
    .references(() => clientPeriodStatus.id, { onDelete: "cascade" }),
