...
// Enums
export const trackingCycleEnum = pgEnum("tracking_cycle", [
  "monthly",
  "quarterly",
]);
...
export const pensionTypes = pgTable(
  "pension_types",
  {
    ...lookupColumns,
    code: varchar("code", { length: 50 }).notNull(), // Override to remove unique constraint
...
export const pensionerTypes = pgTable(
  "pensioner_types",
  {
    ...lookupColumns,
...
export const products = pgTable(
  "products",
  {
    ...lookupColumns,
    companyId: uuid("company_id").references(() => companies.id),
    trackingCycle: trackingCycleEnum("tracking_cycle")
      .default("monthly")
      .notNull(),
  },
  (table) => ({
...
export const parStatuses = pgTable(
  "par_statuses",
  {
    ...lookupColumns,
...
export const statusTypes = pgTable(
  "status_types",
  {
    ...lookupColumns,
...
// Status Reasons
export const statusReasons = pgTable(
  "status_reasons",
  {
    ...lookupColumns,
...
export const pensionTypesRelations = relations(
  pensionTypes,
  ({ one, many }) => ({
