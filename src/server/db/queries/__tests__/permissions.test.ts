...
describe('Permission Queries', () => {
  ...
  describe('getPermissionsByResource', () => {
    it('should return permissions for a specific resource', async () => {
      ...
      const result = await permissionQueries.getPermissionsByResource(db, 'users')
  ...
  describe('getUserPermissions', () => {
    it('should return user permissions with scopes', async () => {
      ...
      const result = await permissionQueries.getUserPermissions(db, '1', 'company-1')
  ...
  describe('setUserPermissions', () => {
    it('should replace all user permissions', async () => {
      ...
      const result = await permissionQueries.setUserPermissions(db, '1', permissionsData)
  ...
  describe('userHasPermission', () => {
    it('should return true if user has permission', async () => {
      ...
      const result = await permissionQueries.userHasPermission(db, '1', 'users', 'read', 'company-1')
    ...
    it('should return false if user does not have permission', async () => {
      ...
      const result = await permissionQueries.userHasPermission(db, '1', 'users', 'delete', 'company-1')
