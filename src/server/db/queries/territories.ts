 ...
 */
export async function assignBranchesToUser(db: any, userId: string, branchIds: string[]) {
  try {
 ...
 */
export async function assignAreasToUser(db: any, userId: string, areaIds: string[]) {
  try {
    if (areaIds.length === 0) {
      return []
    }
 ...
 */
export async function removeBranchesFromUser(db: any, userId: string, branchIds: string[]) {
  try {
    if (branchIds.length === 0) {
      return []
    }
 ...
 */
export async function removeAreasFromUser(db: any, userId: string, areaIds: string[]) {
  try {
    if (areaIds.length === 0) {
      return []
    }
