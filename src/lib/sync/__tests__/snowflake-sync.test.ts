...
describe("Snowflake Sync", () => {
  ...
  describe("buildLookupCache", () => {
    it("should build lookup cache with all maps", async () => {
      const mockPensionTypes = [{ id: "pt1", code: "SSS", name: "SSS" }];
      const mockBranches = [{ id: "b1", code: "B001", name: "Branch 1" }];
  ...
  describe("transformRecord", () => {
    it("should transform snowflake record to client data", () => {
      ...
      const result = snowflakeSync.transformRecord(
        snowflakeRecord,
        lookupCache,
      );
