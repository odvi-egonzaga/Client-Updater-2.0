...
describe("Territory Filter", () => {
  ...
  describe("getUserBranchIds", () => {
    it("should return cached branch IDs", async () => {
      ...
      const result = await territoryFilter.getUserBranchIds(
        "user1",
        "company1",
      );
    ...
    it("should fetch from database on cache miss", async () => {
      ...
      const mockAreaBranches = [{ branchId: "branch3" }];
  ...
  describe("getUserBranchFilter", () => {
    it("should return all scope if user has all access", async () => {
      ...
      const result = await territoryFilter.getUserBranchFilter(
        "user1",
        "company1",
      );
  ...
  describe("canAccessBranch", () => {
    it("should return true if user has all scope", async () => {
      ...
      const result = await territoryFilter.canAccessBranch(
        "user1",
        "company1",
        "branch3",
      );
