  ...
  try {
    ...
    if (eventType === "session.ended") {
      ...
      try {
        ...
        logger.error(
          "Failed to process session end via webhook",
          error as Error,
          {
            action: "session_ended",
            clerkId: userId,
        ...
        return new Response("Error: Failed to process session end", {
          status: 500,
        });
      }
    }
    ...
    if (eventType === "organizationMembership.created") {
      ...
      try {
        ...
        logger.error(
          "Failed to create organization membership via webhook",
          error as Error,
          {
            action: "organization_membership_created",
            clerkId: userId,
        ...
        return new Response("Error: Failed to create organization membership", {
          status: 500,
        });
      }
    }
    ...
    if (eventType === "organizationMembership.updated") {
      ...
      try {
        ...
        logger.error(
          "Failed to update organization membership via webhook",
          error as Error,
          {
            action: "organization_membership_updated",
            clerkId: userId,
        ...
        return new Response("Error: Failed to update organization membership", {
          status: 500,
        });
      }
    }
