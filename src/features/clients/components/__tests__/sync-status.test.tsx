...
describe('SyncStatus', () => {
  ...
  it('renders sync actions card', () => {
    ...
    expect(screen.getByRole('button', { name: /start snowflake sync/i })).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /start nextbank sync/i })).toBeInTheDocument()
  })
  ...
  it('calls trigger sync when snowflake sync button is clicked', async () => {
    ...
    const snowflakeButton = screen.getByRole('button', { name: /start snowflake sync/i })
  ...
  it('calls trigger sync when nextbank sync button is clicked', async () => {
    ...
    const nextbankButton = screen.getByRole('button', { name: /start nextbank sync/i })
  ...
  it('disables sync buttons when sync is pending', () => {
    ...
    expect(screen.getByRole('button', { name: /start snowflake sync/i })).toBeDisabled()
    expect(screen.getByRole('button', { name: /start nextbank sync/i })).toBeDisabled()
  })
