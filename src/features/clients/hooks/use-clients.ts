  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        const response = await fetch(`${CLIENTS_API_BASE}?${params.toString()}`)
...
export function useClient(
  clientId: string,
  options?: Omit<UseQueryOptions<ApiResponse<ClientWithDetails>>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
...
export function useClientSyncHistory(
  clientId: string,
  options?: Omit<UseQueryOptions<ApiResponse<ClientSyncHistory[]>>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
    queryKey: ['clients', clientId, 'sync-history'],
    queryFn: async () => {
      const response = await fetch(`${CLIENTS_API_BASE}/${clientId}/sync-history`)
...
export function useClientSearch(
  ...
  options?: Omit<UseQueryOptions<ApiResponse<ClientSearchResult[]>>, 'queryKey' | 'queryFn'>
) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`${CLIENTS_API_BASE}/search?${params.toString()}`)
